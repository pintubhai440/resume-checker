...
# Yeh har candidate ke result ko save karega
...
resume_text = st.text_area("Paste the Resume Text here", height=300, label_visibility="collapsed")

# --- ANALYSIS BUTTON & LOGIC ---
if st.button("Analyze & Add Candidate", use_container_width=True, type="primary"):
    
    if not resume_text or not job_description or not candidate_name:
        st.warning("Please provide the Job Description, Candidate's Name, and Resume text.")
    else:
        with st.spinner(f'Analyzing {candidate_name}\'s resume... This might take a moment.'):
            ...
            try:
                ...
                if start_index != -1 and end_index != -1:
                    ...
                    # Naye candidate ka data save karein
                    st.session_state.candidates.append({
                        "name": candidate_name,
                        "analysis": analysis_result,
                        "resume": resume_text # Resume text ko bhi save karein
                    })
...
if not st.session_state.candidates:
    ...
    # Candidates ko score ke hisaab se sort karein (sabse a accha upar)
    ...
    for candidate in sorted_candidates:
        ...
        # Har candidate ke liye ek expander banayein
